...
//     this.setState({
//       txtFrase: '"' + this.frase[numeroAleatorio] + '"',
...
//         <Text style={estilo.frase}>{this.state.txtFrase}</Text>

//         <TouchableOpacity style={estilo.botao} onPress={this.abrir}>
//           <View style={estilo.botaoContainer}>
//             <Text style={estilo.btnAbrirBiscoito}>Abrir biscoito</Text>
//           </View>
//         </TouchableOpacity>
